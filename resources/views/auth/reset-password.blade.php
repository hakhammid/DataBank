<x-auth-layout :title="'Reset Password - ' . config('constants.APP_TITLE')">
                ...
                <div>
                    ...
                    <div>
                        <form method="POST" action="{{ route('password.store') }}" class="space-y-6">
                            ...
                            <!-- Password -->
                            <div>
                                <label for="password" class="mb-1.5 block text-sm font-medium text-zinc-950">
                            ...
                            <!-- Confirm Password -->
                            <div>
                                <label for="password_confirmation" class="mb-1.5 block text-sm font-medium text-zinc-950">
