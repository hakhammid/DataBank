<x-guest-layout :title="'Reset Password'">
    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
        <form method="POST" action="{{ route('password.store') }}" class="space-y-6">
            ...
            <div>
                ...
                <div x-data="{ showPassword: false }" class="relative">
                    <input :type="showPassword ? 'text' : 'password'" id="password" name="password" value="{{ old('password') }}"
                        ...
                        class="h-11 w-full rounded-lg border border-zinc-300 bg-transparent py-2.5 pl-4 pr-11 text-sm text-zinc-800 shadow-theme-xs placeholder:text-zinc-400 focus:border-primary focus:outline-hidden focus:ring-3 focus:ring-primary/10" />
            ...
            <div>
                <label for="password_confirmation" class="mb-1.5 block text-sm font-medium text-zinc-700">
