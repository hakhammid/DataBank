    ...
    <style>
        ...
        * {
        ...
        @media print {
            ...
            .data-table thead th, .data-table tbody tr:nth-child(even) {
...
<body>
    <div class="report-container">
        <div class="report-header">
            ...
            <div class="report-title">Department Modules Report</div>
        ...
        <table class="data-table">
            <thead>
                <tr>
                    ...
                    <th>Department</th>
                    <th style="text-align: center; width: 150px;">Total Modules</th>
                </tr>
            </thead>
            <tbody>
