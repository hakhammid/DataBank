...
<html>
<head>
    <title>Faculty Members Report - {{ config('constants.APP_TITLE') }}</title>
    <style>
        @page {
            size: A4;
            margin: 20mm 15mm;
...
<body>
    <div class="report-container">
        <div class="report-header">
            ...
            <div class="report-title">Faculty Members Report</div>
        ...
        <div class="summary-section">
            <div class="summary-card">
                <div class="card-value">{{ count($faculties) }}</div>
                <div class="card-label">Total Faculty</div>
            </div>
            <div class="summary-card">
                <div class="card-value">{{ $faculties->unique('department_id')->count() }}</div>
            ...
            <tbody>
                @foreach($faculties as $index => $faculty)
                    <tr>
                        ...
                        <td style="font-weight: 600;">{{ $faculty->id_number ?? 'N/A' }}</td>
                        <td>{{ $faculty->name }}</td>
                        <td>{{ $faculty->email }}</td>
        ...
        <div class="report-footer">
            ...
            <div class="footer-right">
                <div>Report Reference: FAC-{{ date('Ymd-His') }}</div>
                <div>Page 1 of 1</div>
            </div>
        </div>
    </div>
