...
<html>
<head>
    <title>Degree Programs Report - {{ config('constants.APP_TITLE') }}</title>
    <style>
        @page {
            size: A4;
            margin: 20mm 15mm;
...
<body>
    <div class="report-container">
        <div class="report-header">
            ...
            <div class="report-title">Degree Programs Report</div>
        ...
        <div class="summary-section">
            <div class="summary-card">
                <div class="card-value">{{ count($courses) }}</div>
        ...
        <div class="report-footer">
            ...
            <div class="footer-right">
                <div>Report Reference: DEG-{{ date('Ymd-His') }}</div>
                <div>Page 1 of 1</div>
            </div>
        </div>
    </div>
