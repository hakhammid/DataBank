<x-admin-layout :title="'Add Degree Program'">
    <main class="flex-1 max-h-full p-5 lg:mt-0 mt-20">
        <div class="flex items-center gap-0">
            ...
            <h1 class="text-2xl/8 font-semibold text-zinc-950 sm:text-xl/8 ">Create Degree Program</h1>
        </div>
        <hr role="presentation" class="my-10 w-full border-t border-zinc-950/5 ">
        <form method="POST" class="mx-auto" action="{{ route('admin.create.degree-program') }}">
            @csrf
                ...
                <div>
                    <span data-slot="control"
                        ...
                        <input type="text" aria-label="Degree Program Name"
                            ...
                            id="add-degree-program-name-input" data-headlessui-state="" placeholder="" value="{{ old('degree_program') }}" name="degree_program" required autofocus>
                        </span>
