<x-admin-layout :title="'Edit Faculty'">
        ...
        <form method="POST" class="mx-auto" action="{{ route('admin.update-faculty', $faculty->id) }}">
            ...
            <section class="grid gap-x-8 gap-y-8 sm:grid-cols-2">
                <div class="space-y-1">
                    ...
                    <img src="{{ $faculty->profile_picture ? asset('images/' . $faculty->profile_picture) : asset('images/default_profile.png') }}" alt="Profile Picture" class="w-20 h-20 rounded-full bg-gray-200 border-[0.5px] border-zinc-950/10 object-cover" id="preview-image" draggable="false" ondragstart="return false;" onselectstart="return false;">
                </div>
            </section>
            ...
            <section class="grid gap-x-8 gap-y-6 sm:grid-cols-2">
                ...
                <div><span data-slot="control"
                        ...
                        <input type="text" aria-label="Faculty First Name"
                            ...
                            id="faculty-first-name-input" data-headlessui-state="" placeholder="Enter the faculty first name" value="{{ $faculty->first_name }}" name="first_name" required autofocus>
                        </span>
            ...
            <section class="grid gap-x-8 gap-y-6 sm:grid-cols-2">
                ...
                <div><span data-slot="control"
                        class="relative block w-full before:absolute before:inset-px before:rounded-[calc(theme(borderRadius.lg)-1px)] before:bg-white before:shadow after:pointer-events-none after:absolute after:inset-0 after:rounded-lg after:ring-inset after:ring-transparent sm:after:focus-within:ring-2 sm:after:focus-within:ring-blue-500 has-[[data-disabled]]:opacity-50 before:has-[[data-disabled]]:bg-zinc-950/5 before:has-[[data-disabled]]:shadow-none before:has-[[data-invalid]]:shadow-red-500/10">
                        <input type="text" aria-label="Faculty Middle Initial"
                            class="relative block w-full appearance-none rounded-lg px-[calc(theme(spacing[3.5])-1px)] py-[calc(theme(spacing[2.5])-1px)] sm:px-[calc(theme(spacing[3])-1px)] sm:py-[calc(theme(spacing[1.5])-1px)] text-base/6 text-zinc-950 placeholder:text-zinc-500 sm:text-sm/6  border border-zinc-950/10 data-[hover]:border-zinc-950/20  bg-transparent focus:outline-none data-[invalid]:border-red-500 data-[invalid]:data-[hover]:border-red-500 data-[disabled]:border-zinc-950/20"
                            id="faculty-middle-initial-input" data-headlessui-state="" placeholder="Enter the faculty middle initial" value="{{ $faculty->middle_initial }}" name="middle_initial" autofocus>
                        </span>
            ...
            <section class="grid gap-x-8 gap-y-6 sm:grid-cols-2">
                ...
                <div><span data-slot="control"
                        class="relative block w-full before:absolute before:inset-px before:rounded-[calc(theme(borderRadius.lg)-1px)] before:bg-white before:shadow after:pointer-events-none after:absolute after:inset-0 after:rounded-lg after:ring-inset after:ring-transparent sm:after:focus-within:ring-2 sm:after:focus-within:ring-blue-500 has-[[data-disabled]]:opacity-50 before:has-[[data-disabled]]:bg-zinc-950/5 before:has-[[data-disabled]]:shadow-none before:has-[[data-invalid]]:shadow-red-500/10">
                        <input type="text" aria-label="Faculty Last Name"
                            class="relative block w-full appearance-none rounded-lg px-[calc(theme(spacing[3.5])-1px)] py-[calc(theme(spacing[2.5])-1px)] sm:px-[calc(theme(spacing[3])-1px)] sm:py-[calc(theme(spacing[1.5])-1px)] text-base/6 text-zinc-950 placeholder:text-zinc-500 sm:text-sm/6  border border-zinc-950/10 data-[hover]:border-zinc-950/20  bg-transparent focus:outline-none data-[invalid]:border-red-500 data-[invalid]:data-[hover]:border-red-500 data-[disabled]:border-zinc-950/20"
                            id="faculty-last-name-input" data-headlessui-state="" placeholder="Enter the faculty last name" value="{{ $faculty->last_name }}" name="last_name" required autofocus>
                        </span>
            ...
            <section class="grid gap-x-8 gap-y-6 sm:grid-cols-2">
                ...
                <div><span data-slot="control"
                        ...
                        <input type="email" aria-label="Faculty Email"
                            class="relative block w-full appearance-none rounded-lg px-[calc(theme(spacing[3.5])-1px)] py-[calc(theme(spacing[2.5])-1px)] sm:px-[calc(theme(spacing[3])-1px)] sm:py-[calc(theme(spacing[1.5])-1px)] text-base/6 text-zinc-950 placeholder:text-zinc-500 sm:text-sm/6  border border-zinc-950/10 data-[hover]:border-zinc-950/20  bg-transparent focus:outline-none data-[invalid]:border-red-500 data-[invalid]:data-[hover]:border-red-500 data-[disabled]:border-zinc-950/20"
                            id="faculty-email-input" data-headlessui-state="" value="{{ $faculty->email }}" placeholder="Enter the faculty email"
            ...
            <section class="grid gap-x-8 gap-y-6 sm:grid-cols-2">
                ...
                <div><span data-slot="control" class="relative block w-full before:absolute before:inset-px before:rounded-[calc(theme(borderRadius.lg)-1px)] before:bg-white before:shadow after:pointer-events-none after:absolute after:inset-0 after:rounded-lg after:ring-inset after:ring-transparent sm:after:focus-within:ring-2 sm:after:focus-within:ring-zinc-500 has-[[data-disabled]]:opacity-50 before:has-[[data-disabled]]:bg-zinc-950/5 before:has-[[data-disabled]]:shadow-none before:has-[[data-invalid]]:shadow-red-500/10">
                        <span data-slot="control" class="group relative block w-full before:absolute before:inset-px before:rounded-[calc(theme(borderRadius.lg)-1px)] before:bg-white dark:before:hidden after:pointer-events-none after:absolute after:inset-0 after:rounded-lg after:ring-inset after:ring-transparent after:has-[[data-focus]]:ring-2 after:has-[[data-focus]]:ring-blue-500 has-[[data-disabled]]:opacity-50 before:has-[[data-disabled]]:bg-zinc-950/5 before:has-[[data-disabled]]:shadow-none">
                            <select class="relative block w-full appearance-none rounded-lg py-[calc(theme(spacing[2.5])-1px)] sm:py-[calc(theme(spacing[1.5])-1px)] pl-[calc(theme(spacing[3.5])-1px)] pr-[calc(theme(spacing.10)-1px)] sm:pl-[calc(theme(spacing.3)-1px)] sm:pr-[calc(theme(spacing.9)-1px)] [&amp;_optgroup]:font-semibold text-base/6 text-zinc-950 placeholder:text-zinc-500 sm:text-sm/6 dark:text-white dark:*:text-white border border-zinc-950/10 data-[hover]:border-zinc-950/20 dark:border-white/10 dark:data-[hover]:border-white/20 bg-transparent dark:bg-white/5 dark:*:bg-zinc-800 focus:outline-none data-[invalid]:border-red-500 data-[invalid]:data-[hover]:border-red-500 data-[disabled]:border-zinc-950/20 data-[disabled]:opacity-100 disabled:opacity-50 disabled:cursor-not-allowed" id="course_id" data-headlessui-state="" name="course_id" disabled>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const currentCourseId = '{{ $faculty->course_id }}';

            function loadCourses(departmentId, preselectCourseId) {
                if (!departmentId) {
                ...
                fetch(`/api/departments/${departmentId}/courses`)
                    ...
                    .then(courses => {
                        ...
                        courses.forEach(course => {
                            ...
                            if (preselectCourseId && preselectCourseId == course.id) {
            ...
            // On page load, if department is pre-selected, load its courses and pre-select the current one
            if (departmentSelect.value) {
                loadCourses(departmentSelect.value, currentCourseId);
            }
        });
    </script>
</x-admin-layout>